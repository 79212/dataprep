...
def render_heatmaps(df: pd.DataFrame, plot_width: int, plot_height: int) -> Figure:
    """
...
def render_bar_chart(
    ...
    value_type = ["NotNull", "Null"]

    data = {
        "cols": data_barchart.index,
        "NotNull": data_barchart["nonnull"],
        "Null": data_barchart["null"],
    }
